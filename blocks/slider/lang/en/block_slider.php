...
$string['user'] = 'users';
$string['access']= 'You have no access!';
$string['coursesEnrolled']= 'Enrolled';
$string['coursesCompleted']= 'Completed';
$string['completedActivitiesCount']= 'Activities';
$string['activitiesDueCount']= 'Due';
$string['totalCertificate']= 'Certificate';
$string['totalTimespent']= 'Time Spent(H:m)';
$string['totalCashback']= 'Cash Point Earn';
