...
$top_viewed         = $data->get_top_viewed('top_view_course');
...
?>
	var dataperview = google.visualization.arrayToDataTable([
		...
		["<?php echo $top_viewed[0]['course']; ?>", <?php echo $top_viewed[0]['view']; ?>, "#edb879"],
		["<?php echo $top_viewed[1]['course']; ?>", <?php echo $top_viewed[1]['view']; ?>, "#1979a9"],
		["<?php echo $top_viewed[2]['course']; ?>",<?php echo $top_viewed[2]['view']; ?>, "#69bdd2"],
		["<?php echo $top_viewed[3]['course']; ?>", <?php echo $top_viewed[3]['view']; ?>, "#042f66"],
		["<?php echo $top_viewed[4]['course']; ?>",<?php echo $top_viewed[4]['view']; ?>, "#cce7e8"] 
	]);
...
<div class="reports-both-blocks">
	...
	<div class="col-md-2">
	<?php 
	/*$html = '<a class="btn btn-primary new-button" href= "'.$CFG->wwwroot.'/local/camproctor/viewimages.php">'
            .  'Secure Exam Report'
            . '<i class="icon-link"></i>'
            . '</a>';
		echo $html;
...
<div class="row dashbo graph-report mt-5">
  <div class="col-xl-4 col-md-6">
		<div id="report_accordion" class="panel-group"> 
			...
			<?php echo get_report_menu_html($menu); ?> 
		</div>
	</div>
		<div class="col-xl-4 col-md-6" >
