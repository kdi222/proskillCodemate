...
function CreateSchedulingReport($form_data=array())
{
  ...
  function report_schreport_runable_options($type = null) {
    ...
    return array('daily' => get_string('automaticallydaily', 'report_customsqlrap'),
                 'weekly' => get_string('automaticallyweekly', 'report_customsqlrap'),
                 'monthly' => get_string('automaticallymonthly', 'report_customsqlrap')
    );
}
